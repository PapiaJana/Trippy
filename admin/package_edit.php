...
<body>
    <div class="container-fluid   m-0 p-0">
            ...
            <!-- <div class="row edit_back">
                ...
                <ul><h2 class="text-dark text-center"> Edit Package</h2></ul>
        
            <div class="row" style="margin: 0 10% 0 10%;">
                <div class="col-md-6">
                    <form action="package_edit_action.php" class="needs-validation edit" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="user_id" value="<?php echo $data['p_id']; ?>" />
                        <div class="row g-2">
                        <div class="col-12">
                                <label for="destination" class="form-label text-dark">Destination:</label>
                                <input type="text" class="form-control " name="destination" id="destination" placeholder="" required="" value="<?php echo $data['destination']; ?>" >
