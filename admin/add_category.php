    ...
    <div class="container-fluid">
      <div class="row my-4">
        <div class=" col-md-12">
          ...
          <form action="add_category_action.php" class="add_pack" method="post" enctype="multipart/form-data">
            
            <div class="form-group from">
              <label for="destination" class="text-light">category Name : </label>
              <input type="text" class="form-control   " id="category" placeholder="category" name="category"><br>
            </div>
            <!-- <div class="form-group from">
            ...
            <div class="row">
              ...
              <div class="form-group">
                ...
                <!-- <div class="form-group">
                    <img src="../assets/catagory/<?php echo $data['image'] != '' ? $data['image'] : 'no-image.png'; ?>" alt=" " style="height:100px;width:100px" id="view_profile_pic">
                </div> -->
              </div><br>
