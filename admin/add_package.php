...
<body>
  ...
  <section>
    <div class="container-fluid">
      <div class="row my-4">
        <div class=" col-md-12">
          <h1 class="text-center text-light" style="color: black; text-align:center;text-decoration:underline; font-size:30px;">Add Package</h1>

          <form action="add_package_action.php" class="add_pack" method="post" enctype="multipart/form-data">
            <div class="form-group from">
              <label for="category" class="text-light">Category: </label>
              <input type="text" class="form-control   " id="category" placeholder="which india?" name="category"><br>
            </div>
            <div class="form-group from">
              <label for="destination" class="text-light">Destination Name : </label>
              <input type="text" class="form-control   " id="destination" placeholder="Destination Name" name="destination"><br>
            </div>
            <div class="form-group from">
              <label for="days" class="text-light">How many Days : </label>
              <input type="text" class="form-control " id="days" placeholder="How many days" name="days">
            </div>
            ...
            <div class="row">
              <div class="col-md-5">
                <div class="form-group">
                  ...
                  <input type="hidden" name="old_img" val ue="<?php echo $data['image'] ?>" />
                  <input type="file" class="form-control" name="pic" id="pic" accept="image/*" onchange="viewImage(this)">
                </div>
                <!-- <div class="form-group">
                    <img src="assets/package_image/<?php echo $data['image'] != '' ? $data['image'] : 'no-image.png'; ?>" alt=" " style="height:100px;width:100px" id="view_profile_pic">
                </div> -->
              </div><br>
              <div class="form-group from">
