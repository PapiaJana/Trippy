...
<div class="container">
        ...
        <a href="category_list.php" class="active">Category List</a>
            ...
            <div class="row g-2">
                <div class="col-12">
                    <div class="bg-light rounded h-100 p-4">
                        <span>
                            <h4 class="mb-4 text-dark fs-5 fw-5">All Category<a href="add_category.php " style="margin-left: 70%;" class=" btn btn-warning">+add category</a></h4>
                        </span>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><img src="../assets/catagory/<?php echo $data['image'] != '' ? $data['image'] : 'no-image.png'; ?>" alt="" style="height:50px;" id="view_profile_pic"></td>

                                                <td>
                                                    <a href="catagory_edit.php?uid=<?php echo base64_encode($data['id']); ?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                                                    <a href="catagory_delete.php?uid=<?php echo $data['id']; ?>" class="btn btn-sm btn-danger delete_btn" onclick="return confirm('Are you sure?');"><i class="fa fa-trash"></i></a>
                                                </td>
