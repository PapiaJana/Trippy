...
<div class="container">
        ...
        <a href="package_list.php" class="active">Package List</a>
            ...
            <div class="row g-2">
                <div class="col-12">
                    <div class="bg-light rounded h-100 p-4">
                        <span>
                            <h4 class="mb-4 text-dark fs-5 fw-5">All Package<a href="add_package.php " style="margin-left: 70%;" class=" btn btn-warning">+add package</a></h4>
                        </span>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            <tr>
                                                ...
                                                <td><img src="../assets/package_image/<?php echo $data['image'] != '' ? $data['image'] : 'no-image.png'; ?>" alt="" style="height:50px;" id="view_profile_pic"></td>

                                                <td>
                                                    <a href="package_edit.php?uid=<?php echo base64_encode($data['p_id']); ?>" class="btn btn-sm btn-warning"><i class="fa fa-edit"></i></a>
                                                    <a href="package_delete.php?uid=<?php echo $data['p_id']; ?>" class="btn btn-sm btn-danger delete_btn" onclick="return confirm('Are you sure?');"><i class="fa fa-trash"></i></a>
                                                </td>
