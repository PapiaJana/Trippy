...
//echo $user_id;
$data = getPackageDetails($user_id);
...
<body>
    <div class="container-fluid   m-0 p-0">
            ...
            <!-- <div class="row edit_back">
                ...
                <ul><h2 class="text-dark text-center"> Edit service</h2></ul>
        
            <div class="row" style="margin: 0 10% 0 10%;">
                <div class="col-md-6">
                    <form action="service_edit_action.php" class="needs-validation edit" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="user_id" value="<?php echo $data['id']; ?>" />
                        <div class="row g-2">
                        <div class="col-12">
                                <label for="destination" class="form-label text-dark">Service: </label>
                                <input type="text" class="form-control " name="destination" id="destination" placeholder="" required="" value="<?php echo $data['service']; ?>" >
                                <!-- <div class="invalid-feedback">
                                    Please enter your shipping address.
                                </div> -->
                            </div>
                            <div class="col-12">
                                <label for="days" class="form-label text-dark">Description :</label>
                                <input type="text" class="form-control " name="days" id="days" placeholder="" value="<?php echo $data['description'] ?>">
                                <!-- <div class="invalid-feedback">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5">
                            <img src="../assets/package_image/<?php echo $data['image'] !='' ? $data['image'] : 'no-img.jpg'; ?>" alt=" " style="height:100px;width:100px" id="view_profile_pic">
                                <!-- </div> -->
                            </div>
                        </div>
                        <hr class="my-4">
                        <button class="w-20 btn btn-warning btn-lg " style="background-color:orange ;margin-left:50%;" type="submit" fdprocessedid="g2865" name="packageEditBtn">Submit</button><br>
                    </form>
                    </div>
                    <div class="col-md-6">
