    ...
    <div class="row g-4">
        <div class="col-12">
            <div class="bg-light rounded h-100 p-4">
                <h2 class="mb-4  fs-5 fw-5" style="color:black;">All Users</h2>
                           ...
                           if(isset($alldata)){
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td><img src="../assets/user_image/<?php echo $data['image']!='' ? $data['image'] : 'no-image.png'; ?>" alt="" style="height:50px;" id="view_profile_pic"></td>
