...
<div class="container">
        ...
        <a href="book_list.php" class="active">Book List</a>
        <a href="contact_list.php">Contact List</a>
       
    </div>
    <div class="content">
    <div class="container-fluid vw-100" style="padding-right: 300px;">
    <div class="row g-4">
        <div class="col-12">
            <div class="bg-light rounded h-100 p-4">
                <h3 class="mb-4  fs-5 fw-5">All Booking</h3>
                           ...
                           if(isset($alldata)){
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <a href="book_delete.php?uid=<?php echo $data['c_id']; ?>" class="btn btn-sm btn-danger delete_btn" ><i class="fa fa-trash"></i></a>
                                        </td>
